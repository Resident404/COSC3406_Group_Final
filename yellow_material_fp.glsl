...
// Material attributes - YELLOW for lane dividers
vec4 ambient_color = vec4(0.2, 0.2, 0.0, 1.0);
vec4 diffuse_color = vec4(1.0, 1.0, 0.2, 1.0);
vec4 specular_color = vec4(1.0, 1.0, 0.6, 1.0);
