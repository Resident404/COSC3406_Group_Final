...
// Material attributes - GREEN for grass/trees
vec4 ambient_color = vec4(0.0, 0.15, 0.0, 1.0);
vec4 diffuse_color = vec4(0.1, 0.8, 0.1, 1.0);
vec4 specular_color = vec4(0.4, 0.9, 0.4, 1.0);
