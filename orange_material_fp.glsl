...
// Material attributes - ORANGE for obstacles
vec4 ambient_color = vec4(0.2, 0.1, 0.0, 1.0);
vec4 diffuse_color = vec4(1.0, 0.5, 0.1, 1.0);
vec4 specular_color = vec4(1.0, 0.7, 0.3, 1.0);
float phong_exponent = 48.0;
