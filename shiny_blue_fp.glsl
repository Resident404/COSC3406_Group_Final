...
// Material attributes (constants) - BRIGHT BLUE
vec4 ambient_color = vec4(0.0, 0.1, 0.2, 1.0);
vec4 diffuse_color = vec4(0.2, 0.4, 1.0, 1.0);  // BLUE not red!
vec4 specular_color = vec4(0.6, 0.8, 1.0, 1.0);
