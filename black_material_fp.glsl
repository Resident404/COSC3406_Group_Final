...
// Material attributes - BLACK for track/road
vec4 ambient_color = vec4(0.05, 0.05, 0.05, 1.0);
vec4 diffuse_color = vec4(0.1, 0.1, 0.1, 1.0);  // Dark black/gray
vec4 specular_color = vec4(0.2, 0.2, 0.2, 1.0);
