...
// Material attributes - PURPLE for buildings
vec4 ambient_color = vec4(0.15, 0.05, 0.2, 1.0);
vec4 diffuse_color = vec4(0.6, 0.2, 0.8, 1.0);
vec4 specular_color = vec4(0.8, 0.4, 0.9, 1.0);
